...
var auth_controller_ts_1 = require("../controllers/auth.controller.ts");
 ...
 */
router.post('/auth', auth_controller_ts_1.AuthController.Authenticate);
/**
 * @swagger
 * /register:
 *   post:
 ...
 *         description: Internal server error
 */
router.post('/register', auth_controller_ts_1.AuthController.Register);
